...
export default function Footer() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm leading-6 text-gray-400">
                  Providing expert business cashflow solutions powered by over
                  100 years combined broker experience and supported by the
          ...
          <div className="mt-6 pt-8 text-xs text-gray-500 text-center space-y-3">
            ...
            <p className="leading-relaxed text-left md:text-center">
              ...
              or needs. We recommend that you consider whether it is appropriate
              for your circumstances and your full financial situation will need
              to be reviewed prior to acceptance of any offer or product. It
              does not constitute legal, tax or financial advice and you should
              always seek professional advice in relation to your individual
              circumstances.
            </p>
          </div>
        </div>
      ...
      {/* Talk to Someone Widget - Visible on all pages */}
